...
var APP = (function($, window, document, undefined) {
	...
	return {
		...
		search: function() {
			...
			console.log('search(): curPos', curPos);
		...
		_getTime4SpeedAndDistance: function(nDistMetres, speedMetersPerSec){
			...
			console.log('_getTime4SpeedAndDistance(): ', nDistMetres, speedMetersPerSec);
			...
			sout = this._pad(parseInt(hours), 2) + ":" + this._pad(parseInt(minutes), 2);
